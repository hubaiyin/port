  ...
  <div class="main">
    ...
    <div class="right">
      <div class="loginBox" v-show="status === 'login'">
        ...
        <!-- select -->
        <div class="select">
          <div class="first" @click="chooseOne()" :class="this.way === 1 ? 'choosen' : '' "><span>账户密码登录</span></div>
          <div class="divide">|</div>
          <div class="second" @click="chooseTwo()" :class="this.way ===2 ? 'choosen' : '' "><span>手机短信登录</span></div>
        </div>
        <!-- phone -->
        <div class="phone">
      ...
      <div class="msgBox" v-show="status === 'message'">
        ...
        <!-- phone -->
        <div class="phone">
          <input type="text" placeholder="请输入手机号" v-model="msgParam.phone">
          <img src="../../assets/user.png" alt="">
        </div>
        <!-- msg -->
        <div class="msg">
          <input type="text" placeholder="短信验证码" v-model="msgParam.msgCode">
          <img src="../../assets/msg.png" alt="">
          <button @click="sentLoginMsg()" :class="{'disabled-style':getCodeBtnDisable , 'sentMsg':!getCodeBtnDisable}" :disabled="getCodeBtnDisable">
            <span class="sent">{{ codeBtnWord }}</span>
          </button>
        </div>
        <div class="msgTip">
